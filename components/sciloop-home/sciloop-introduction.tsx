      ...
      <FadeIn>
        <section className="relative overflow-hidden rounded-[42px] border border-white/10 bg-[#07101d]/72 px-6 py-12 shadow-[0_30px_120px_rgba(0,0,0,.38)] md:px-12 md:py-20 lg:px-20">
          ...
          <div className="relative z-10 max-w-4xl">
            ...
            <div className="mt-9 flex flex-wrap gap-3"><ButtonLink href={liveSignalsHref} className="px-6">Explore decision signals <span aria-hidden="true" className="ml-2">→</span></ButtonLink><ButtonLink href="/sciloop/live/google-quantum-chip" variant="secondary" className="px-6">Open the quantum brief</ButtonLink></div>
